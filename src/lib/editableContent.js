...
// Les 3 couleurs de texte disponibles sur le site, pour les titres et
// paragraphes de contenu (pas les boutons, menus ou pages légales).
export const COLOR_OPTIONS = [
  { value: 'gold', label: 'Jaune', hex: '#ffd700' },
  { value: 'white', label: 'Blanc', hex: '#ffffff' },
  { value: 'gray', label: 'Gris', hex: '#b3b3b3' },
]
...
// Couleur par défaut de chaque titre/paragraphe personnalisable — reprend
// exactement la couleur déjà utilisée dans le code, pour que rien ne change
// tant que le client n'a pas fait de choix dans l'admin.
export const COLORABLE_DEFAULTS = {
  'home.hero.title': 'white',
  'home.hero.subtitle': 'gray',
  'home.how.eyebrow': 'gold',
  'home.how.title': 'white',
  'home.how.item1.title': 'white',
  'home.how.item1.text': 'gray',
  'home.how.item2.title': 'white',
  'home.how.item2.text': 'gray',
  'home.how.item3.title': 'white',
  'home.how.item3.text': 'gray',
  'home.how.item4.title': 'white',
  'home.how.item4.text': 'gray',
  'home.how.item5.title': 'white',
  'home.how.item5.text': 'gray',
  'home.how.item6.title': 'white',
  'home.how.item6.text': 'gray',
  'home.what.eyebrow': 'gold',
  'home.what.title': 'white',
  'home.what.text': 'gray',
  'services.mariages.titre': 'white',
  'services.mariages.description': 'gray',
  'services.evenements-prives.titre': 'white',
  'services.evenements-prives.description': 'gray',
  'services.seminaires.titre': 'white',
  'services.seminaires.description': 'gray',
  'services.ateliers-cocktails.titre': 'white',
  'services.ateliers-cocktails.description': 'gray',
  'about.title': 'white',
  'about.intro1': 'gray',
  'about.intro2': 'gray',
  'about.journey.title': 'white',
  'about.journey.subtitle': 'gray',
  'about.etape1.lieu': 'white',
  'about.etape1.texte': 'gray',
  'about.etape2.lieu': 'white',
  'about.etape2.texte': 'gray',
  'about.etape3.lieu': 'white',
  'about.etape3.texte': 'gray',
  'about.etape4.lieu': 'white',
  'about.etape4.texte': 'gray',
  'about.closing.title': 'white',
  'about.closing.text': 'gray',
  'prestations.title': 'white',
  'prestations.subtitle': 'gray',
  'prestations.hero.title': 'white',
  'prestations.hero.intro': 'gray',
  'prestations.hero.tagline': 'gold',
  'prestations.section1.title': 'white',
  'prestations.section1.text1': 'gray',
  'prestations.section1.text2': 'gray',
  'prestations.section2.title': 'white',
  'prestations.section2.text1': 'gray',
  'prestations.section2.text2': 'gray',
  'prestations.section3.title': 'white',
  'prestations.section3.intro': 'gray',
  'prestations.detail1.title': 'white',
  'prestations.detail1.text': 'gray',
  'prestations.detail2.title': 'white',
  'prestations.detail2.text': 'gray',
  'prestations.detail3.title': 'white',
  'prestations.detail3.text': 'gray',
  'prestations.section4.title': 'white',
  'prestations.section4.text': 'gray',
  'prestations.closing.title': 'white',
  'prestations.closing.text': 'gray',
  'cocktails.title': 'white',
  'cocktails.subtitle': 'gray',
  'cocktails.experience.elegante': 'gray',
  'cocktails.experience.festive': 'gray',
  'cocktails.experience.sur-mesure': 'gray',
  'cocktails.menu.eyebrow': 'gold',
  'cocktails.menu.title': 'white',
  'cocktails.menu.subtitle': 'gray',
  'cocktails.menu.upsell': 'gray',
  'cocktails.wine.eyebrow': 'gold',
  'cocktails.wine.title': 'white',
  'cocktails.wine.subtitle': 'gray',
  'cocktails.final.title': 'white',
  'cocktails.final.text': 'gray',
}
